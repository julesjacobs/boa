...
pub fn is_state(w: u32) -> bool { w & 1 == 0 }
pub fn get_state(w: u32) -> u32 { w >> 1 }
pub fn get_header(w: u32) -> u32 { w >> 1 }
pub fn put_state(w: u32) -> u32 { w << 1 }
pub fn put_header(w: u32) -> u32 { (w << 1) | 1 }

/// Assumes that the header tag has already been removed
pub fn decode_header(w: u32) -> (u8,u8,u16) { ((w >> 24) as u8, (w >> 16) as u8, w as u16) }
pub fn encode_header(typ: u8, tag: u8, len: u16) -> u32 { ((typ as u32) << 24) | ((tag as u32) << 16) | (len as u32) }
